...
$fatpacked{"apps/vmware/connector/mode/netvm.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_CONNECTOR_MODE_NETVM';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vmware/connector/mode/statuscluster.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_CONNECTOR_MODE_STATUSCLUSTER';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vmware/connector/mode/vsanclusterusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_CONNECTOR_MODE_VSANCLUSTERUSAGE';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
