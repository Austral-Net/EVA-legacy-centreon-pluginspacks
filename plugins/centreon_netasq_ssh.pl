...
$fatpacked{"network/netasq/local/mode/qosusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NETASQ_LOCAL_MODE_QOSUSAGE';
  #
  # Copyright 2017 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/netasq/local/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NETASQ_LOCAL_PLUGIN';
  #
  # Copyright 2017 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
