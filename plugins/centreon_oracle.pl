...
$fatpacked{"database/oracle/mode/dataguard.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_ORACLE_MODE_DATAGUARD';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/oracle/mode/listtablespaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_ORACLE_MODE_LISTTABLESPACES';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
