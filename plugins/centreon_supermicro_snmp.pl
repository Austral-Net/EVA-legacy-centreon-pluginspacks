...
$fatpacked{"hardware/server/supermicro/superdoctor/snmp/mode/hardware.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_SUPERMICRO_SUPERDOCTOR_SNMP_MODE_HARDWARE';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/server/supermicro/superdoctor/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_SUPERMICRO_SUPERDOCTOR_SNMP_PLUGIN';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
