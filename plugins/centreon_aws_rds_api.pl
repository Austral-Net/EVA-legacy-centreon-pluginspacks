...
$fatpacked{"cloud/aws/rds/mode/discovery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_DISCOVERY';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/rds/mode/storage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_STORAGE';
  #
  # Copyright 2020 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
